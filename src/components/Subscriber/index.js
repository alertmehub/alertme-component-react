...
import {setCredentials,sendUpdates,loadSubscriber} from '../../actions';
...
class Subscriber extends Component {
    ...
    /*
     * D E L E T E   D E L I V E R Y   O P T I O N   A N D   U P D A T E   S U B S C R I B E R
     */
    
    deleteDeliveryOptionAndUpdateSubscriber(e,option) {
    ...
    /*
     * R E N D E R   S U B S C R I P T I O N S
     */
	...
	if (subscriber.subscriptions) {
	    for (let i=0;i<subscriber.subscriptions.length;i++) {
		subscriptionsToRender.push(
			<Subscription
		    key={i}
	...
	return (
		<div>
		{/* I C O N S */}
		<svg xmlns="http://www.w3.org/2000/svg" className="chat">
		{/* chat icon */}
		<symbol id="chat" viewBox="0 0 511.626 511.626">
		<title>text</title>
		...
		{/* phone icon */}
		<symbol id="phone-call" viewBox="0 0 438.536 438.536">
		...
		<DeliveryOptions
	    deleteDeliveryOptionAndUpdateSubscriber={this.deleteDeliveryOptionAndUpdateSubscriber}
		/>
		</div>
		<div>
...
export default connect(mapStateToProps, {setCredentials,sendUpdates,loadSubscriber})(Subscriber);
